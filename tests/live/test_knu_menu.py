...
from app.services.ops import crawl_daily_meals
...
class TestKnuWeekParse:
    ...
    def test_corner_only_title_uses_body(self):
        ...
        <table class="tstyle_me"><tr>
          <th>분류</th><th>월<p class="week_t">(07/27)</p></th>
        </tr></table>
...
class TestKnuBuildDailyMeals:
    ...
    def test_crawl_daily_meals_routes_knu(self, shop35_html: str):
        with (
            patch("app.services.ops._validate_source_url"),
            patch(
                "app.domain.crawler.knu_menu.fetch_html",
                return_value=shop35_html,
            ),
